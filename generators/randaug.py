...
#copied and adapted from the imgaug repository https://github.com/aleju/imgaug/blob/0101108d4fed06bc5056c4a03e2bcb0216dac326/imgaug/augmenters/collections.py#L231
#Now it applies only the augmentation steps that apply transformations in the colorspace and skip rotation, translation, cropping, flipping, shearing etc
