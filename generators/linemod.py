...
if __name__ == "__main__":
    ...
    train_gen = LineModGenerator("D:\\CV\DATASET\\Linemod_preprocessed", object_id = 1, rotation_representation = 'axis_angle')
    test_gen = LineModGenerator("D:\\CV\\DATASET\\Linemod_preprocessed", object_id = 1, train = False, rotation_representation = 'axis_angle')
