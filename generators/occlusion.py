...
class OcclusionGenerator(Generator):
    ...
    def map_object_ids_to_class_labels(self, object_ids_dict, name_to_class_dict):
        """
       Creates two dictionaries containing the Occlusion dataset object id as key and the model class label as value and vice versa
        Args:
            object_ids_dict: Dictionary mapping the Occlusion object names to their object id's
            name_to_class_dict: Dictionary mapping the Occlusion object name to the model class label
        Returns:
            Dictionaries containing the Occlusion dataset object id as key and the model class label as value and vice versa
    ...
    def load_model_3d_points(self, all_models_path, name_to_object_id, name_to_class):
        ...
        Args:
            ...
            name_to_class: Dictionary mapping the Occlusion object name to the model class label
        Returns:
    ...
    def prepare_dataset(self, object_path, data_examples, gt_dict, info_dict, class_to_valid_examples):
        """
       Prepares the Occlusion dataset and converts the data from the Linemod format to the model format
        Args:
        ...
        Returns:
            ...
            depth_paths: List with all depth image paths in the dataset split (Currently not used in model)
...
if __name__ == "__main__":
    ...
    train_gen = OcclusionGenerator("D:\\CV\\DATASET\\Linemod_preprocessed", use_6DoF_augmentation = True, use_colorspace_augmentation = True)
