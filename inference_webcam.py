...
def main():
    """
    Run Dense6DPose in inference mode live on webcam.
...
def get_linemod_camera_matrix():
    ...
    """
    return np.array([[607.90124512, 0., 299.13088323], [0., 608.67333984, 262.61719733], [0., 0., 1.]], dtype = np.float32)
