...
def parse_args(args):
    ...
    linemod_parser.add_argument('--object-id', help = 'ID of the Linemod Object to train on', type = int, default = 15)
...
def main(args=None):
    ...
    """
    # args = ['--phi', '0', '--backbone', 'densenet', '--weights', 'D:\\temp\\best.h5', '--validation-image-save-path', 'D:\\temp\\evaluation_test', 'occlusion', 'D:\CV\DATASET\Linemod_preprocessed']   
    args = ['--phi', '0', '--backbone', 'densenet', '--weights', 'C:\CV\Dense6DPose\checkpoints\\best_phi0.h5', 'occlusion', 'D:\CV\DATASET\Linemod_preprocessed']
    ...
    print("\nBuilding the Model...")
    _, prediction_model = build_Model(args.phi,
